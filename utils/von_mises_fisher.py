# code taken from https://github.com/nicola-decao/s-vae-pytorch/tree/master/hyperspherical_vae/distributions
import math
...
class VonMisesFisher(torch.nn.Module):
    ...
    def __init__(self, loc, logscale, k=1):
        super().__init__()
        self.dtype = loc.dtype
        self.loc = torch.nn.parameter.Parameter(loc)
        self.logscale = torch.nn.parameter.Parameter(logscale)
